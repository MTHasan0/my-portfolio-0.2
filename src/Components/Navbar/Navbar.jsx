...
const Navbar = () => {
    ...
    return (
        <nav className='flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'>
            <div className=' flex w-full text-white text-3xl xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-20 xl:h-max py-8 bg-gradient-to-r from-black to-blue-800 lg:bg-none lg:bg-white/20 backdrop-blur-lg xl:text-2xl xl:rounded-full'>
